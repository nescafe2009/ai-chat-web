...
cd ai-chat-web/nexus-plugin
./install.sh --agent-name serina --hub2d-url http://111.231.105.183:9800

# 方式 2: 手动安装
cp -r nexus-plugin/* ~/.openclaw/extensions/nexus/
...
# 3. 运行回归脚本
NEXUS_TO_AGENT=serina ./nexus-regression.sh
```
